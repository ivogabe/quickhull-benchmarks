...
-- ==
-- "circle"
-- script input { points_from_string ($loadbytes "../input/25M_circle.dat") }
-- "rectangle"
-- script input { points_from_string ($loadbytes "../input/25M_rectangle.dat") }
-- "quadratic"
-- script input { points_from_string ($loadbytes "../input/25M_quadratic.dat") }
...
import "../CFAL-bench/quickhull/futhark/lib/github.com/diku-dk/sorts/radix_sort"
...
module input = import "../CFAL-bench/quickhull/futhark/input"
